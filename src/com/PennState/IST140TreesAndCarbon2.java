...
public class IST140TreesAndCarbon2 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            // Create do-while loop to scan user inputs/report errors
            do {
                // Prompt user to input data for height for tree at index i
                System.out.print("Enter the height <space> diameter, " +
                                    "both in cm: ");

                // Call inputDiameter method and assign it to index i
                treeHeight[i] = inputHeight(scnr);
                // Call inputDiameter method and assign it to index i
                treeDiameter[i] = inputDiameter(scnr);
            }
            // Repeat loop when height is less than / equal to 30.48...
            // ...OR diameter is less than / equal to 2
            while ((treeHeight[i] <= 30.48) || (treeDiameter[i] <= 2));
        }
    ...
    /**
     * Allows user to input double value for the tree height,
     * prints error if input is smaller than or equal to 30.48
     *
     ...
     * @return      User input value for height
     *
     */
    ...
    public static double inputHeight(Scanner scnr) {
        ...
        // Create if statement, when input is less than/equal to 30.48...
        if (userInput <= 30.48) {
            // ...print out error message
            System.out.println("*** ERROR: The height must be " +
                                "greater than 30.48 cm. Please try again.");
        }
    ...
    /**
     * Allows user to input double value for the tree diameter,
     * prints error message if smaller than or equal to 2.0
     *
     * It is assumed that all parameters have previously been assigned
     * relevant values prior to calling the method.
     *
     * @param scnr  The scanner object used to receive user input
     * @return      User input value for diameter
     *
     */
    ...
    public static double inputDiameter(Scanner scnr) {
        ...
        // Create if statement that when input is less than/equal to than 2...
        if (userInput <= 2) {
            // ...print out error message
            System.out.println("*** ERROR: The height must be " +
                                "greater than 2.0 cm. Please try again.");
        }
    ...
    public static void dataTable(double[] treeHeight,
        ...
        // Print out total carbon dioxide label, spaced 45 chars from left
        System.out.printf("\n\n%45s", "TOTAL CO2: ");
        // Print out total carbon dioxide rounded to 2 decimal places, rounded
